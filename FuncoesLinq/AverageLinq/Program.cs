...
namespace AverageLinq
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Average divide o valor total pela quantidade de itens da nossa lista

            //Aqui o Sum soma valores do total de vendas dos produto baseados na quantidade * valor
            Console.WriteLine(vendas.Sum(x => (x.Quantidade * x.Valor)));
