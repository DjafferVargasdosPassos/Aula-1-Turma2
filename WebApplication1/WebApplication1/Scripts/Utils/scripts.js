...
$(document).ready(function () {    
    ...
    $('#Button1').click(function () {
        ...
        $.each(data, function (key, value) {
            //criamos uma variaval que ira armazenar a informção
            var templateContent = "";
            //iniciamos um separador de informações 
            templateContent += "{";
            // outro laço para repetir para cada informação
            $.each(value, function (key, value) {
                // adicionamos toda as informações do nosso objeto
            ...
            $('#divContent').append(
                ...
                "<div> CEP: " + value.cep + "</div> " +
                "<div> Logradouro: " + value.logradouro + "</div> " +
                "<div> Complemento: " + value.complemento + "</div> " +
                "<div> Bairro: " + value.bairro + "</div> " +
                "<div> Localidade: " + value.localidade + "</div> " +
                "<div> UF: " + value.uf + "</div> " +
                "<div> unidade :" + value.unidade + "</div> " +
                "<div> Ibge: " + value.ibge + "</div> " +
                "<div> Gia: " + value.gia + "</div>" +
                "</div>"
            );
        });
